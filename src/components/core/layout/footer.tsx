...
export default function Footer() {
  return (
    <footer className="mb-8 sm:mb-16">
      <ul className="mt-6 flex flex-row space-x-4 font-sm text-neutral-600 sm:mt-8 dark:text-neutral-300">
        <li>
          <a
      ...
      <p className="mt-6 text-neutral-600 text-sm sm:mt-8 dark:text-neutral-300">
