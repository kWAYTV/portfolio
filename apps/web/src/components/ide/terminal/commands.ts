...
} from "@/components/ide/terminal/commands-data";
...
// biome-ignore lint/performance/noBarrelFile: backward compat, commands-data is internal
export { MOCK_CWD, MOCK_FILES } from "@/components/ide/terminal/commands-data";
